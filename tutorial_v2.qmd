...
### 2. Lim et al. (2014)
https://wviechtb.github.io/metadat/reference/dat.lim2014.html
<!-- remove study from random effect -->
...
# check the tree
is.ultrametric(tre_lim2014) # FALSE
is.binary(tre_lim2014)  # TRUE

# need to compute branch length
