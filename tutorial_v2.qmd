...
Using the estimated $\rho$, we can construct the OU phylogenetic correlation matrix as:$$A_{OU} = \exp(-\alpha D)$$. This matrix is the theoretical phylogenetic correlation structure implied by the OU process.
